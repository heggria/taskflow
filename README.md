...
<p>
  ...
  <a href="#whats-inside"><img src="https://img.shields.io/badge/tests-892-6E8BFF?style=flat-square" alt="892 tests"></a>
...
**0 runtime dependencies** · **892 tests** · **9 phase types** · **shared context tree** · **cross-session resume** · **cross-run memoization** · **per-item map caching** · **incremental recompute** · **FlowIR compile seam** · **detached execution** · **`compile` Mermaid renderer** · **~9k LOC runtime**
