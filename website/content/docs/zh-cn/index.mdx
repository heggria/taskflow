...
> **0.3 candidate——未发布、未 GA。** 在人工创建并发布 `v0.3.0` 前，已发布 package 仍保持 0.2.x 版本线。
...
0.3 candidate 当前从仓库源码开发。稳定的已发布宿主 package 仍请按现有宿主指南操作，并保持已发布的 0.2.x package pin。
...
- **0.3-C Control Plane：** 活跃实现轨道，负责 ControlHost、项目 store、协调、审批、receipts 与后续 evidence UI。它不是 0.3 MVP 的 GA 定义，WebUI 也尚未在当前 candidate 交付。
