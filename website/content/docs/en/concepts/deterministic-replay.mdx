...
**Deterministic replay** (also *replayable-for-what-if*) answers a different question from [Resume](/en/docs/concepts/resume) or [incremental recompute](/en/docs/reference/incremental-recompute).
...
- [Incremental recompute](/en/docs/reference/incremental-recompute) — FlowIR, staleness, surgical re-run
