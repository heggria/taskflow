...
Use when several approaches can answer the same question and you want the **fastest** successful result (not a quality judge).
...
| "Keep the first approach that finishes" | `race` | Latency over exhaustive wait/judge. |
