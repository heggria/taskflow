---
title: Budget
description: Run-wide observed-usage cost and token stop-losses.
---
...
| Grok Build 0.2.93 | None; every flow declaring `budget` is rejected because Grok reports neither tokens nor cost |
