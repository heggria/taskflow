...
<Steps>
  ...
  <Step>
    **Say what you expected and what you got.** "I expected the `map` to fan out over 4 items, but only 2 ran" is actionable. "It didn't work" is not. Include the host (Pi, Codex, Claude Code, OpenCode, Grok Build, Hermes Agent) and the agent name if relevant.
  </Step>
</Steps>
