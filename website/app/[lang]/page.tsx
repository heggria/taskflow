...
const copy = {
	en: {
		...
		hero: {
			eyebrow: "taskflow 0.3 · Trusted Effects candidate",
			title: [
				"Declare the effect.",
				"Verify the path.",
		...
		install: {
			label: "Stable 0.2.x host installs — candidate runs from source.",
			copy: "Copy",
			copied: "Copied",
			guide: "Guide",
		},
	...
	"zh-cn": {
		...
		install: {
			label: "稳定 0.2.x 宿主安装；candidate 请从源码运行。",
			copy: "复制",
			copied: "已复制",
			guide: "指南",
		},
...
export default async function HomePage({
	...
	const jsonLd = {
		...
		name: "taskflow",
		softwareVersion: "0.3.0-candidate",
