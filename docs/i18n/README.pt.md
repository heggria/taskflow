...
taskflow é um *grafo de tarefas* declarativo e verificável para Pi, Codex, Claude Code, OpenCode, Grok Build e Hermes Agent. Linha 0.2.10: Node.js ≥ 22.19.0, 12 tipos de fase e mais de 1500 testes. A camada MCP não depende de um SDK MCP; core usa `typebox` como peer e o DSL depende de TypeScript.
