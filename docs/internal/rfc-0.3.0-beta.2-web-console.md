...
`184fb5af9ee2f678e57ff33adc01e6c38fda1e59` and source digest
...
1,217.9 ms cold-Home p95, 465.0 ms warm-Home p95, 24.4 ms cached-Pro p95,
225.9 ms event-to-painted-detail p95 (81.5 ms commit→receipt and 161.3 ms
receipt→paint diagnostic p95s), 8.5 ms list response, and 0.0742 maximum CLS
session window. Owner-ready and launch-to-useful p95s are retained separately
as 18.286 s and 19.132 s. The Simple shell is 209,367 gzip bytes. The schema-v4
...
11.69/7.97/7.26 and 7.57/7.97/7.54. Because this is not the canonical M2 Mac
...
- [ ] Cross-browser matrix on supported current Chrome/Edge, Firefox, and
  ...
  close. Native Edge, Safari reject/cancel/current-session/peer-session cases,
