...
The latest local report at source digest
`sha256:e6b8b3dc50fca74dd6f9e292ab67911a26bdfb214ddec9b9e4d3989c6b7b7378`
is a **non-canonical structural pass**, not release performance evidence:
MacBook Pro M3 Pro, Node 24.18.0, Chromium 149.0.7827.55, 30 samples,
492.2 ms cold-Home p95, 451.8 ms warm-Home p95, 27.3 ms cached-Pro p95,
229.5 ms event-to-painted-detail p95 (66.2 ms commit→receipt and 167.3 ms
receipt→paint diagnostic p95s), 8.1 ms list response, and 0.0586 maximum CLS
session window. Owner-ready and launch-to-useful p95s are retained separately
as 2.76 s and 3.27 s. The Simple shell is 209,073 gzip bytes. The schema-v4
report proves the exact primary Node version, AC power, no recorded
thermal/performance warning, and pre/post load averages of 5.61/5.86/6.71 and
6.29/5.97/6.54. Because this is not the canonical M2 Mac mini profile, every
latency result remains informational and the canonical gate stays open.
