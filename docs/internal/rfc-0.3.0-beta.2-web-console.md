...
`fb765b21cc284cf70e84a577f190c4bce38d0a79` and source digest
...
502.0 ms cold-Home p95, 537.7 ms warm-Home p95, 29.0 ms cached-Pro p95,
574.6 ms event-to-painted-detail p95 (212.8 ms commit→receipt and 496.7 ms
receipt→paint diagnostic p95s), 12.9 ms list response, and 0.0251 maximum CLS
session window. Owner-ready and launch-to-useful p95s are retained separately
as 3.30 s and 3.85 s. The Simple shell is 209,114 gzip bytes. The schema-v4
...
8.42/5.90/5.59 and 14.65/8.55/6.69. Because this is not the canonical M2 Mac
mini profile, every latency result remains informational. In particular, the
574.6 ms event-to-painted-detail p95 is above the 250 ms canonical budget
without being either a canonical pass or failure. The canonical gate stays
open.
