...
- packaged browser: the approval-enhanced source state passes Chromium
  ...
  session as the mutation actor; the rerun on evidence tip `e19dfd45` binds
  the byte-identical `aa34369a` candidate source and does not claim a
