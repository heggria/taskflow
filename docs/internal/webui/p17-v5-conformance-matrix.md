...
- packaged browser: the approval-enhanced source state passes Chromium
  ...
  ancestral separately scoped read/keyboard, allow/revoke-all,
  ...
  usability pass and no longer proves the later session-revocation source.
...
performance evidence, current-source native Safari invalidation, native
Edge/AT review, reviewed-tip
