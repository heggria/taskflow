...
| 2026-08-03-multiflow-consumer-migration | three consumer branches | no | accepted | 0 | 0 | — | one deterministic artifact set; fresh archives; 6/6 acceptance each; real healthy observers | multi-Flow branches retained; npm publish and merges still pending | n/a/n/a | — | — | — | existing Project/Flow maps; no new runtime concept | 0/0/0 |
