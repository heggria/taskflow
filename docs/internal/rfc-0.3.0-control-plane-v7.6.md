> **SNAPSHOT (read-only reference):** copied verbatim from archive branch
> `origin/backup/0.3-archive/mac-feat-0.3.0-control-plane` @ docs/internal/rfc-0.3.0-control-plane.md (v7.6, 2026-07-22).
> 0.3-C 以本快照为**设计蓝本**：抄概念，不搬代码。P1–P16 ADR 与 wire-freeze 见
> `docs/internal/p-adrs/` 与 `docs/internal/wire-freeze.md`。任何后续修订只能发生在 P-ADR 层，
> 本快照不再演进。
